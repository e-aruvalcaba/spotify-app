...
import { ContentComponent } from '../arquitecture/content/content/content.component';
...
@Component({
  selector: 'app-home',
  standalone: true,
  imports: [SidebarComponent, ContentComponent, RinfoModule, InfoComponent, UtileriaComponent, PlayerComponent],
